...
export default function GCatalogHome() {
  const { user } = useAuth()
      ...
      <main className="flex-1 px-4 md:px-6 py-12 md:py-20">
          ...
          <section className="content-container-wide mx-auto mt-16 scroll-reveal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-6">
                ...
                <div className="mt-4">
                  <Link href="/gcatalog/leaderboard" className="text-sm font-medium">
                    View Leaderboard →
                  </Link>
                </div>
              </div>
                  ...
                  <div className="space-y-2">
                    {user.favorites.slice(0, 3).map((gameId) => {
                      ...
                      return (
                        <div key={gameId} className="flex justify-between items-center">
                          ...
                          <Link
                            href={game.category ? `/gcatalog/play/${game.id}` : `/gcatalog/games/${game.id}`}
                    ...
                    {user.favorites.length > 3 && (
                      <div className="mt-2 text-center">
                        <Link href="/gcatalog/favorites" className="text-sm font-medium">
                          View All Favorites →
                        </Link>
                      </div>
                    )}
        ...
        <section className="content-container-wide mx-auto mt-16 scroll-reveal">
          ...
          <div className="mt-4 text-center">
            <Link href="/gcatalog/games" className="inline-flex items-center text-sm font-medium">
              View All Games →
            </Link>
          </div>
        </section>
        ...
        <section className="content-container-wide mx-auto mt-16 scroll-reveal">
          ...
          <div className="mt-4 text-center">
            <Link href="/gcatalog/play" className="inline-flex items-center text-sm font-medium">
